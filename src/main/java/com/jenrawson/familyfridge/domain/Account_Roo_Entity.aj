...
privileged aspect Account_Roo_Entity {
    ...
    public void Account.remove() {
        ...
        if (this.entityManager.contains(this)) {
            ...
            Account attached = this.entityManager.find(this.getClass(), this.id);
    ...
    public static long Account.countAccounts() {
        return ((Number) entityManager().createQuery("select count(o) from Account o").getSingleResult()).longValue();
    }
