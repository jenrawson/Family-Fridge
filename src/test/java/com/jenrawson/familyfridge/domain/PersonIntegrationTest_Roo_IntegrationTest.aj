...
import com.jenrawson.familyfridge.domain.PersonDataOnDemand;
...
privileged aspect PersonIntegrationTest_Roo_IntegrationTest {
    ...
    private static final LocalServiceTestHelper PersonIntegrationTest.helper = new LocalServiceTestHelper(new com.google.appengine.tools.development.testing.LocalDatastoreServiceTestConfig());
    
    @BeforeClass
    public static void PersonIntegrationTest.setUp() {
        helper.setUp();
    }
    
    @AfterClass
    public static void PersonIntegrationTest.tearDown() {
        helper.tearDown();
    }
    ...
    public void PersonIntegrationTest.testCountPeople() {
        ...
        long count = com.jenrawson.familyfridge.domain.Person.countPeople();
    ...
    public void PersonIntegrationTest.testFindPerson() {
        com.jenrawson.familyfridge.domain.Person obj = dod.getRandomPerson();
        ...
        obj = com.jenrawson.familyfridge.domain.Person.findPerson(id);
    ...
    public void PersonIntegrationTest.testFindAllPeople() {
        ...
        java.util.List<com.jenrawson.familyfridge.domain.Person> result = com.jenrawson.familyfridge.domain.Person.findAllPeople();
    ...
    public void PersonIntegrationTest.testFindPersonEntries() {
        ...
        java.util.List<com.jenrawson.familyfridge.domain.Person> result = com.jenrawson.familyfridge.domain.Person.findPersonEntries(0, (int) count);
    ...
    public void PersonIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyPerson(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        com.jenrawson.familyfridge.domain.Person merged = (com.jenrawson.familyfridge.domain.Person) obj.merge();
        obj.flush();
    ...
    public void PersonIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'Person' failed to initialize correctly", dod.getRandomPerson());
        com.jenrawson.familyfridge.domain.Person obj = dod.getNewTransientPerson(Integer.MAX_VALUE);
    ...
    public void PersonIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'Person' with identifier '" + id + "'", com.jenrawson.familyfridge.domain.Person.findPerson(id));
    }
